...
using Cloud.Rjc.Web.App.Startup;//SPA!
using Cloud.Rjc.Web.Areas.Mpa.Startup;//MPA!
using Cloud.Rjc.Web.Bundling;
using Cloud.Rjc.Web.Navigation;
using Cloud.Rjc.Web.Routing;
using Cloud.Rjc.WebApi;
