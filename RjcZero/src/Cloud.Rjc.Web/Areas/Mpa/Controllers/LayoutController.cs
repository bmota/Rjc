...
using Cloud.Rjc.Sessions;
using Cloud.Rjc.Web.Areas.Mpa.Models.Layout;
using Cloud.Rjc.Web.Areas.Mpa.Startup;
using Cloud.Rjc.Web.Controllers;
using Cloud.Rjc.Web.Models.Layout;
using Cloud.Rjc.Web.Session;
using HeaderViewModel = Cloud.Rjc.Web.Areas.Mpa.Models.Layout.HeaderViewModel;
