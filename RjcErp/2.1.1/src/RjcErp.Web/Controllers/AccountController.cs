...
using RjcErp.Sessions;
using RjcErp.Web.Controllers.Results;
using RjcErp.Web.Models;
using RjcErp.Web.Models.Account;
...
{
    public class AccountController : RjcErpControllerBase
    {
